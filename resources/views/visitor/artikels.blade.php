    ...
    <div class="col-12">
        <div class="card" style="height: 700px; width: 500px">
          <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0,0.7)">
                 ...
                 <img src="{{asset($articles->art_image)}}" style="height: 500px; width: 300px" class="card-img-top" alt="...">
                 <div class="card-body">
                 ...
                 <div class="card-footer">
                         <a href="/articles/{{$articles->art_slug}}" class="btn" style="rgb(202, 141, 109)">Baca Selengkapnya</a>
                 </div>
         </div>
     </div>
   </div>
